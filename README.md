...
- [Brian](https://github.com/use-brian/use-brian) [![Brian stars](https://img.shields.io/github/stars/use-brian/use-brian?style=flat&label=stars)](https://github.com/use-brian/use-brian/stargazers) - Contributing to a local framework for AI agents, workflows, and documentation.
- [agentbox](https://github.com/awcjack/agentbox) [![agentbox stars](https://img.shields.io/github/stars/awcjack/agentbox?style=flat&label=stars)](https://github.com/awcjack/agentbox/stargazers) - A Nix-based sandbox for running AI coding agents in isolation.
